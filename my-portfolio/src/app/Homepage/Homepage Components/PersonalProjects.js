    ...
    return (
        <section className="h-[300-vh]  bg-jetBlack snap-start">
            <div className="grid grid-col-3 grid-rows-2 pb-10 pt-40 ms px-28 gap-10 col-auto">
                ...
                <div className="col-start-1 row-start-2 border border-limeGreen bg-secondary h-96 rounded-3xl  transition-all duration-200 ease-linear">
                ...
                <div className="col-start-1 row-start-1 border border-poppyRed bg-secondary h-96 rounded-3xl  transition-all duration-200 ease-linear">
